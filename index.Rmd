---
title: "Plantilla para rOpenSpain"
subtitle: "Para su uso en presentaciones de nuestros paquetes"  
author: 
  - "Diego Hernangómez"
date: '`r Sys.Date()`'
output:
...
[`rOpenSpain.css`](https://github.com/rOpenSpain/rosxarigan/blob/master/rOpenSpain.css) y 
[`rOpenSpain.js`](https://github.com/rOpenSpain/rosxarigan/blob/master/rOpenSpain.css) 
en la carpeta de trabajo.

2. Configurar la presentación `xarigan` con los siguientes parámetros:
...
GitHub repo: https://github.com/rOpenSpain/rosxarigan
